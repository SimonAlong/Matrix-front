...
import findRoute, {
  getUrlQuery,
} from '/Users/zhouzhenyong/project/isyscore/isc-config-ui/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/zhouzhenyong/project/isyscore/isc-config-ui',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
