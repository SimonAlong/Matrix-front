export default {
  ...
  // 配置中心
  'menu.appManagerList': '应用配置',
  'menu.configItemList': '配置项',
  'menu.commonConfigItem': '公共配置项',
  'menu.commonConfigList': '公共配置',
  'menu.profileManagerList': '环境变量',
};
